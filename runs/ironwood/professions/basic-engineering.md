...
The permanent current Ironwood Iron Bar baseline is **3.00 Town Buy / 3.15 Town Sell**. Current Basic Engineering recipes with verified Iron Bar, Iron Pipe, Iron Wheel or Cast Iron Stove exposure are repriced from that baseline.
...
| Mechanical Water Pump | 1 | **51.07** | **53.62** |
| Carbon Filter | 1 | **6.66** | **6.99** |
| Wooden Elevator | 1 | **111.75** | **117.34** |
| Basic Engineering Upgrade | 2 | **32.02** | **33.62** |
| Stop Sign | 2 | **21.78** | **22.87** |
| Street Sign | 2 | **21.78** | **22.87** |
| Hand Plow | 2 | **46.77** | **49.11** |
...
4 Iron Bars + 4 Iron Oxide + 90 calories -> 2. Current cash cost = **5.348 per Magnet**.

**Magnet: 6.15 / 6.46.**

## Iron-sensitive infrastructure

The verified current recipes produce these new baseline values:

- Mechanical Water Pump **51.07 / 53.62**;
- Stop Sign **21.78 / 22.87**;
- Street Sign **21.78 / 22.87**;
