# Ironwood Smelting — Current Steam-Era Table

Rebuilt from the supplied Eco 14 Core using the commercially viable Mining chain.

Smelting is a Depth-2 industrial conversion. Bars/pipes receive moderate margins, furniture/decor ordinary margins, and workstations/upgrades capital margins.

## Current metal foundation
...
## Current Smelting workstations / capital goods
...
Advanced Smelting/Steel production is a future transition layer for this run and does not set the current prices above. Research/skill books remain under the separate research economy.
